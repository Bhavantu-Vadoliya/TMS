...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1"><b>SignUp</b>Employee</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Register a new membership</p>

      <form action="emp_register_db.php" method="post">
      ...
      <a href="sign_in.php" class="text-center">I already have a membership</a><br>
      <a href="register_admin.php" class="text-center">Register as admin</a><br>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
